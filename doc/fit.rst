...
.. function:: fit(LassoPath, X, y, d=Normal(), l=canonicallink(d); ...)
    ...
    .. math:: \underset{\beta}{\operatorname{argmax}} \frac{1}{N} \mathbb{L}(y|X,\beta) + (1-\alpha)\frac{1}{2}\|\beta\|_2^2 + \alpha\|\beta\|_1
    ...
    :math:`\mathbb{L}(y|X,\beta) = \frac{1}{2}\|y - X\beta|_2^2`
